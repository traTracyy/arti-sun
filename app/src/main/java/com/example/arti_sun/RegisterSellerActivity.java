...
public class RegisterSellerActivity extends AppCompatActivity {
    ...
    private EditText namehint,phonenumberhint, emailhint,passwordhint,passwordhint2,shophint,addresshint;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shophint = findViewById(R.id.shophint);
    ...
    private String name,shopname,email,phnum,password,cpassword,address;
    ...
    private void inputData(){
        ...
        shopname=shophint.getText().toString().trim();
    ...
    private void reqisterselleracc(){
            ...
            ref.child(firebaseAuth.getUid()).setValue(hashMap)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void unused) {
                            progressDialog.dismiss();
                            startActivity(new Intent(RegisterSellerActivity.this, MSellerActivity.class));
                            finish();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
